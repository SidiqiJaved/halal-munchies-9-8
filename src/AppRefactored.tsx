...
export default function App() {
  ...
  const renderCurrentSection = (): JSX.Element => {
    ...
    switch (appState.currentSection) {
      ...
      case "ordering":
        return <OnlineOrdering onSectionChange={handleSectionChange} />;
      case "catering":
        return <CateringSection onSectionChange={handleSectionChange} />;
      case "locations":
        return <LocationsSection onSectionChange={handleSectionChange} />;
      case "contact":
