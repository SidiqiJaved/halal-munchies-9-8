...
export function CustomerWebsite({ onSectionChange }: CustomerWebsiteProps) {
  ...
  return (
    <div className="bg-halal-cream min-h-screen">
      {/* Hero Banner */}
      <div className="bg-gradient-to-r from-halal-green to-halal-green-light py-20" style={{ backgroundColor: '#2d5a27' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl mb-6 text-white" style={{ color: '#ffffff' }}>
            Welcome to Halal Munchies
          </h1>
          <p className="text-xl sm:text-2xl mb-4 text-white opacity-90" style={{ color: '#ffffff' }}>
            Authentic Halal Cuisine & Fresh Flavors
          </p>
          <p className="text-lg sm:text-xl max-w-3xl mx-auto text-white opacity-80" style={{ color: '#ffffff' }}>
            Experience the finest halal food made with love, tradition, and the freshest ingredients. 
            Order online, plan your catering, or visit one of your locations for an unforgettable meal.
          </p>
        </div>
      </div>
